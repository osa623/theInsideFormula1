...
export default function MonitorScreen({
  ...
  const normalRef = useRef(new THREE.Vector3(0.682, 0, 0.731).normalize())
  ...
  useFrame(({ camera }) => {
    ...
    // Only visible when player is inside the exam room, facing the monitor, and within 10m
    const visible = dist < 10.0 && dot > 0.08 && camera.position.x > 18 && camera.position.z > 115
